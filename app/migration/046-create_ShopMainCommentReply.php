...
return [
  'up' => "CREATE TABLE `ShopMainCommentReply` (
    `id`                int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `shopMainId`        int(11) unsigned NOT NULL COMMENT 'ShopMain ID',
    `shopMainCommentId` int(11) unsigned NOT NULL COMMENT 'ShopMainComment ID',
  ...
  'down' => "DROP TABLE `ShopMainCommentReply`;",

  'at' => "2018-12-04 23:12:26"
];
